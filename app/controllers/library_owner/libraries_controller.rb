...
private
  def library_params
    params.require(:library).permit(:name, :address1,:address2,:state,:city,:landmark,:zip_code, :open, :seats,:contact_number,:user_id,:monthly, :quaterly, :halfyearly, :yearly,images_attributes: [:id, :avatar, :_destroy])
  end
